# %% [markdown]
# # About
#  1. This notebook extracts HAR10 monthly mean data at station locations during BKGN data's duration (1998-2009)
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/7_HAR10/monthly/d10/monthly_means/03_resampled/*.tif"))
...
outFileName = "../../2_ExcelFiles/02_SatDataAtSations/11_har10.csv"
