# %% [markdown]
# # About
#  1. This notebook extracts BKGN monthly mean data at station locations
#  2. The monthly means are also written to a csv file for handy usage
...
# rasters = sorted(glob.glob("../../3_RSData/1_Rasters/2_BKGN/03_resampled/*.tif"))  # original files 
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/2_BKGN/04_refined/*.tif"))  # refined bkgn data
...
outFileName = "../../2_ExcelFiles/02_SatDataAtSations/00_bkgn.csv"
