# %% [markdown]
# # About
#  1. This notebook extracts CHIRPS monthly mean data at station locations during BKGN data's duration (1998-2009)
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/8_CHIRPS/monthly_means/03_resampled/*.tif"))
...
# %% [markdown]
# # Saved the dataframe to excel file
df1 = df.astype('float64')  # dtype changed
outFileName = "../../2_ExcelFiles/02_SatDataAtSations/10_chirps.csv"
