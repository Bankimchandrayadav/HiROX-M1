# %% [markdown]
# # About
#  1. This notebook extracts GPM monthly mean data at station location during BKGN data's duration (1998-2009)
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/1_GPM/monthly_means/3_resampled/*.tif"))
...
outFileName = "../../2_ExcelFiles/02_SatDataAtSations/01_gpm.csv"
