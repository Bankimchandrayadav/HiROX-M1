# %% [markdown]
# # About
#  1. This notebook extracts ERA5lAND monthly mean data at station locations during BKGN data's duration (1998-2009)
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/3_ERA5Land/monthly_means/03_resampled/*.tif"))
...
outFileName = "../../2_ExcelFiles/02_SatDataAtSations/03_era5land.csv"
