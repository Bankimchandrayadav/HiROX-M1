# %% [markdown]
# # About
#  1. This notebook extracts APHRODITE V1101EXR1 monthly mean data at station locations during BKGN data's duration (1998-2009)
#  2. The valeus are then written to a csv file for handy usage
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/6_APHRODITE/V1101EXR1/monthly_means/03_resampled/*.tif"))
...
outFileName = "../../2_ExcelFiles/02_SatDataAtSations/06_aphroV1101EXR1.csv"
