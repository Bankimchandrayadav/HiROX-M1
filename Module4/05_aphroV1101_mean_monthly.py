# %% [markdown]
# # About
#  1. This notebook extracts APHRODITE V1101 monthly mean data at station locations during BKGN data's duration (1998-2009)
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/6_APHRODITE/V1101/monthly_means/03_resampled/*.tif"))
...
outFileName = "../../2_ExcelFiles/02_SatDataAtSations/05_aphroV1101.csv"
