# %% [markdown]
# # About
#  1. This notebook extracts HICHAP monthly mean data at station locations during BKGN data's duration (1998-2009)
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/10_HICHAP/1981-2010/monthly_means/03_resampled/*.tif"))
...
outFileName = "../../2_ExcelFiles/02_SatDataAtSations/13_hichap.csv"
