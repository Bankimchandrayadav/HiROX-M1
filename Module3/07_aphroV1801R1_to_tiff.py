# %% [markdown]
# # About
# This notebook converts APHRODITE V1801R1 netcdf data to tiff format and then reprojects, resamples and clip it to study area's extent
...
# %% [markdown]
# # Read files
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/6_APHRODITE/V1801R1/*.nc"))
...
outDir = "../../3_RSData/1_Rasters/6_APHRODITE/V1801R1/monthly_means/01_netcdf/"  # results directory
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/6_APHRODITE/V1801R1/monthly_means/01_netcdf/*.nc"))  
outDir = "../../3_RSData/1_Rasters/6_APHRODITE/V1801R1/monthly_means/02_tiff/"
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/6_APHRODITE/V1801R1/monthly_means/02_tiff/*.tif"))
outDir = "../../3_RSData/1_Rasters/6_APHRODITE/V1801R1/monthly_means/03_resampled/"
