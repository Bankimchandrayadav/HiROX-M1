# %% [markdown]
# # About
#  This notebook converts HAR10 netcdf data to tiff format and then reprojects, resamples and clips it to study area's extent
...
# %% [markdown]
# # Read files
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/7_HAR10/monthly/d10/*.nc"))
...
outDir = "../../3_RSData/1_Rasters/7_HAR10/monthly/d10/monthly_means/01_netcdf/"  # results directory
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/7_HAR10/monthly/d10/monthly_means/01_netcdf/*.nc"))  
outDir = "../../3_RSData/1_Rasters/7_HAR10/monthly/d10/monthly_means/02_tiff/"
for i in td(range(0, len(rasters)), desc='Converting to tiff'):
    ...
    # proj string taken from "../../03_getting_satellite_data_at_station_locations/13_monthly_har10_at_stations.py"
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/7_HAR10/monthly/d10/monthly_means/02_tiff/*.tif"))
outDir = "../../3_RSData/1_Rasters/7_HAR10/monthly/d10/monthly_means/03_resampled/"
