# %% [markdown]
# # About
#  This notebook converts APHRODITE V1901 netcdf data to tiff format and then reprojects, resamples and clips it to study area's extent
...
# %% [markdown]
# # Read files
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/6_APHRODITE/V1901/*.nc"))
...
outDir = "../../3_RSData/1_Rasters/6_APHRODITE/V1901/monthly_means/01_netcdf/"  
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/6_APHRODITE/V1901/monthly_means/01_netcdf/*.nc"))  
outDir = "../../3_RSData/1_Rasters/6_APHRODITE/V1901/monthly_means/02_tiff/"
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/6_APHRODITE/V1901/monthly_means/02_tiff/*.tif"))
outDir = "../../3_RSData/1_Rasters/6_APHRODITE/V1901/monthly_means/03_resampled/"
