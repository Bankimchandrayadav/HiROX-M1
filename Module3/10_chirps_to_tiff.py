...
# %% [markdown]
# # Read files
ds = xr.open_dataset("../../3_RSData/1_Rasters/8_CHIRPS/chirps-v2.0.monthly.nc") 
...
outDir = "../../3_RSData/1_Rasters/8_CHIRPS/monthly_means/01_netcdf/"  # results directory
...
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/8_CHIRPS/monthly_means/01_netcdf/*.nc"))  
outDir = "../../3_RSData/1_Rasters/8_CHIRPS/monthly_means/02_tiff/"
...
# %% [markdown]
# # Reproject, resample and clip to BKGN files
rasters = sorted(glob.glob("../../3_RSData/1_Rasters/8_CHIRPS/monthly_means/02_tiff/*.tif"))
outDir = "../../3_RSData/1_Rasters/8_CHIRPS/monthly_means/03_resampled/"
